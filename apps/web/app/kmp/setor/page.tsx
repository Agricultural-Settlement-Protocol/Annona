...
=======
      ...
      <section>
        <div className="mb-4 flex items-center gap-2">
          <h2 className="text-base font-bold text-gray-900">Menunggu Setoran</h2>
          <span className="rounded-full bg-amber-50 border border-amber-200/50 px-2.5 py-0.5 text-xs font-bold text-amber-700">
            {filteredPending.length} perjanjian
          </span>
        </div>

        {filteredPending.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-2xl border border-gray-100 bg-gray-50/20 px-6 py-12 shadow-sm">
            <Wheat size={36} className="mb-3 text-gray-400" />
      ...
      {filteredCompleted.length > 0 && (
        <section>
          <div className="mb-4 flex items-center gap-2">
            <h2 className="text-base font-bold text-gray-400">Setoran Selesai</h2>
            <span className="rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-bold text-gray-500 border border-gray-200/30">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-3">
            {filteredCompleted.map(({ agreement, farmer }) => {
              ...
              return (
                <div
                  key={agreement.id}
                  className="rounded-2xl border border-gray-100 bg-gray-50/50 px-4.5 py-4 opacity-80 shadow-sm transition-all hover:bg-gray-100/30"
                >
                  ...
                  {agreement.flag !== "None" && (
                    <p className="mt-2 text-xs font-bold text-amber-705">
                      Flag: {agreement.flag}
                    </p>
                  )}
                </div>
      ...
      <section>
        <div className="mb-4 flex items-center gap-2">
          ...
          <h2 className="text-base font-bold text-gray-900">Riwayat Setoran</h2>
          <p className="text-sm text-gray-500 font-semibold">
