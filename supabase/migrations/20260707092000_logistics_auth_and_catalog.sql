...
-- harvest logistics KMP -> Agrinas.
--
-- NOTE: agreement.expected_harvest_date is added by the earlier migration
-- 20260707091000_agreement_expected_harvest_date.sql (v3-migration branch).
-- Merged 2026-07-07: this migration was renamed 090000 -> 092000 to run AFTER
-- ours and its redundant expected_harvest_date block was removed to avoid a
-- duplicate column-add.

-- ── 1. saprotan catalog: stock status + unit label ──────────────────────────
do $$ begin
